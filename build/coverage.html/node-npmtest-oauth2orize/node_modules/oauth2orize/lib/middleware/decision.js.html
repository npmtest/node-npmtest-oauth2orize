...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/decision.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/decision.js</span></h1>
    <h2>
        
        Statements: <span class="metric">6.52% <small>(3 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/</a> &#187; decision.js</div>
</div>
<div class="body">
 ...
 * @api protected
 */
module.exports = <span class="fstat-no" title="function not covered" >function(server, options, parse, complete) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof options == 'function') {</span>
<span class="cstat-no" title="statement not covered" >    complete = parse;</span>
<span class="cstat-no" title="statement not covered" >    parse = options;</span>
...
<span class="cstat-no" title="statement not covered" >  parse = parse || <span class="fstat-no" title="function not covered" >function(req, done) {</span> <span class="cstat-no" title="statement not covered" >return done(); </span>};</span>
  
<span class="cstat-no" title="statement not covered" >  if (!server) { <span class="cstat-no" title="statement not covered" >throw new TypeError('oauth2orize.decision middleware requires a server argument'); </span>}</span>
  
<span class="cstat-no" title="statement not covered" >  var cancelField = options.cancelField || 'cancel'</span>
    , userProperty = options.userProperty || 'user';
  
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function decision(req, res, next) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    if (!req.oauth2) { <span class="cstat-no" title="statement not covered" >return next(new Error('OAuth2orize requires transaction support. Did you forget oauth2orize.transactionLoader(...)?')); </span>}</span>
    
<span class="cstat-no" title="statement not covered" >    parse(req, <span class="fstat-no" title="function not covered" >function(err, ares, locals) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      var tid = req.oauth2.transactionID;</span>
<span class="cstat-no" title="statement not covered" >      req.oauth2.user = req[userProperty];</span>
<span class="cstat-no" title="statement not covered" >      req.oauth2.res = ares || {};</span>
...
<span class="cstat-no" title="statement not covered" >      if (req.oauth2.res.allow === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        if (!req.body[cancelField]) { <span class="cstat-no" title="statement not covered" >req.oauth2.res.allow = true; </span>}</span>
        else { <span class="cstat-no" title="statement not covered" >req.oauth2.res.allow = false; </span>}
      }
    
      // proxy end() to delete the transaction
<span class="cstat-no" title="statement not covered" >      var end = res.end;</span>
<span class="cstat-no" title="statement not covered" >      res.end = <span class="fstat-no" title="function not covered" >function(chunk, encoding) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (server._txnStore.legacy == true) {</span>
<span class="cstat-no" title="statement not covered" >          server._txnStore.remove(options, req, req.oauth2.transactionID, <span class="fstat-no" title="function not covered" >function noop(){</span>});</span>
        } else {
<span class="cstat-no" title="statement not covered" >          server._txnStore.remove(req, req.oauth2.transactionID, <span class="fstat-no" title="function not covered" >function noop(){</span>});</span>
        }
        
<span class="cstat-no" title="statement not covered" >        res.end = end;</span>
<span class="cstat-no" title="statement not covered" >        res.end(chunk, encoding);</span>
      };
<span class="cstat-no" title="statement not covered" >      req.oauth2._endProxied = true;</span>
