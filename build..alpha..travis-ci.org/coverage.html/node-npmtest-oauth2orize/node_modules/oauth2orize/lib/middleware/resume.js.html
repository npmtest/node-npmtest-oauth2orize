...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/resume.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/resume.js</span></h1>
    <h2>
        
        Statements: <span class="metric">6.76% <small>(5 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">7.46% <small>(5 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/</a> &#187; resume.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function(server, options, immediate, complete) {</span>
...
<span class="cstat-no" title="statement not covered" >    immediate = options;</span>
...
<span class="cstat-no" title="statement not covered" >  if (!server) { <span class="cstat-no" title="statement not covered" >throw new TypeError('oauth2orize.resume middleware requires a server argument'); </span>}</span>
<span class="cstat-no" title="statement not covered" >  if (!immediate) { <span class="cstat-no" title="statement not covered" >throw new TypeError('oauth2orize.resume middleware requires an immediate function'); </span>}</span>
  
<span class="cstat-no" title="statement not covered" >  var userProperty = options.userProperty || 'user';</span>
  
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function resume(req, res, next) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    if (res.locals) {</span>
<span class="cstat-no" title="statement not covered" >      req.oauth2.locals = req.oauth2.locals || {};</span>
<span class="cstat-no" title="statement not covered" >      utils.merge(req.oauth2.locals, res.locals);</span>
    }
...
<span class="fstat-no" title="function not covered" >        function updated(err, tid) {</span>
<span class="cstat-no" title="statement not covered" >          if (err) { <span class="cstat-no" title="statement not covered" >return next(err); </span>}</span>
...
<span class="cstat-no" title="statement not covered" >          txn.client = req.oauth2.client;</span>
<span class="cstat-no" title="statement not covered" >          txn.redirectURI = req.oauth2.redirectURI;</span>
<span class="cstat-no" title="statement not covered" >          txn.req = req.oauth2.req;</span>
<span class="cstat-no" title="statement not covered" >          txn.info = info;</span>
          
<span class="cstat-no" title="statement not covered" >          server._txnStore.update(server, options, req, req.oauth2.transactionID, txn, updated);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          server._txnStore.update(req, req.oauth2.transactionID, req.oauth2, updated);</span>
        }
      }
    }
