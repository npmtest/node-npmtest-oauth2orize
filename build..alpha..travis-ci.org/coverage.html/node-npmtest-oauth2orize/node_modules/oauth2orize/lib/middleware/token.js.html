...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/token.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/token.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/middleware/</a> &#187; token.js</div>
</div>
<div class="body">
 ...
 * @api protected
 */
module.exports = <span class="fstat-no" title="function not covered" >function token(server, options) {</span>
<span class="cstat-no" title="statement not covered" >  options = options || {};</span>
  
<span class="cstat-no" title="statement not covered" >  if (!server) { <span class="cstat-no" title="statement not covered" >throw new TypeError('oauth2orize.token middleware requires a server argument'); </span>}</span>
  
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function token(req, res, next) {</span></span>
<span class="cstat-no" title="statement not covered" >    var type = req.body.grant_type;</span>
    
<span class="cstat-no" title="statement not covered" >    server._exchange(type, req, res, <span class="fstat-no" title="function not covered" >function(err) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      return next(new TokenError('Unsupported grant type: ' + type, 'unsupported_grant_type'));</span>
    });
  };
};
&nbsp;
