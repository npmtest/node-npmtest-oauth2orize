...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oauth2orize/node_modules/oauth2orize/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/index.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">92% <small>(23 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 * @api public
 */
<span class="fstat-no" title="function not covered" >function createServer(options) {</span>
<span class="cstat-no" title="statement not covered" >  var server = new Server(options);</span>
...
fs.readdirSync(__dirname + '/grant').forEach(function(filename) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (/\.js$/.test(filename)) {
