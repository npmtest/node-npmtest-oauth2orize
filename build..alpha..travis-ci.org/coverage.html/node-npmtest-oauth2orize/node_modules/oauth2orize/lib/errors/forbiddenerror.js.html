...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-oauth2orize/node_modules/oauth2orize/lib/errors/forbiddenerror.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/errors/forbiddenerror.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-oauth2orize/node_modules/oauth2orize/lib/errors/</a> &#187; forbiddenerror.js</div>
</div>
<div class="body">
 ...
 * @api public
 */
<span class="fstat-no" title="function not covered" >function ForbiddenError(message) {</span>
...
<span class="cstat-no" title="statement not covered" >  this.status = 403;</span>
}
&nbsp;
/**
 * Inherit from `Error`.
